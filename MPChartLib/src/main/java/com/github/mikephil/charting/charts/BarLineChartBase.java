...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (valuesToHighlight()){
            Log.e("show", "draw Highlight");
            for(int i =0 ; i < mIndicesToHighlight.length; i++){
                Log.e("show", "indix " + i + " " + mIndicesToHighlight[i].toString());
            }
            mRenderer.drawHighlighted(canvas, mIndicesToHighlight);
        }


        mRenderer.drawHighlightedQueue(canvas, mIndicesToHighlightQueue);
    ...
    public void notifyDataSetChanged() {
        ...
        Log.e("axis", "==1== " + mAxisLeft.mAxisMinimum + " | " + mAxisLeft.mAxisMaximum);
        Log.e("axis", "==2== " + mAxisRight.mAxisMinimum + " | " + mAxisRight.mAxisMaximum);
        ...
        //Log.e("axis", "==2== " + mAxisRight.mAxisMinimum + " | " + mAxisRight.mAxisMaximum);
        mXAxisRenderer.computeAxis(mXAxis.mAxisMinimum, mXAxis.mAxisMaximum, false);
        Log.e("axis", "==3== " + mXAxis.mAxisMinimum + " | " + mXAxis.mAxisMaximum);
    ...
    protected void calcMinMax() {
        ...
        float xRange = Math.abs(mData.getXMax() - mData.getXMin());
        float yRange = xRange; //* 0.5f;

        if (GlobalFlags.SpineShapeSegmentFlag){
            mAxisLeft.setAxisMinimum(-yRange/2);
            mAxisLeft.setAxisMaximum(yRange/2);
            mAxisRight.setAxisMinimum(-yRange/2);
            mAxisRight.setAxisMaximum(yRange/2);
            Log.e("axis", "~~~~~~~~ xRange " + xRange + " yRange " + yRange);
        ...
        Log.e("show", GlobalFlags.SpineShapeSegmentFlag + " !!!! calMinMax X = " + mData.getXMin() + " " + mData.getXMax()
        + " Y = " +  mData.getYMin(AxisDependency.LEFT) + " " + mData.getYMax(AxisDependency.LEFT));
    }
