...
public class BubbleChart extends BarLineChartBase<BubbleData> implements BubbleDataProvider {
    ...
    protected void init() {
        ...
        if (GlobalFlags.SpineShapeSegmentFlag){
            mRenderer = new SpineShapeChartRenderer(this, mAnimator, mViewPortHandler);
        }else{
    ...
    public void setChartCallback(SpineShapeChartRenderer.IChartCallback callback){
        ((SpineShapeChartRenderer)mRenderer).setChartCallback(callback);
    }
