...
public class YAxis extends AxisBase {
    ...
    public void calculate(float dataMin, float dataMax) {
        ...
        Log.e("axis", "!!! min " + mAxisMinimum + " max " + mAxisMaximum + " range " + mAxisRange);

        mAxisMinimum = 2*mAxisMinimum;
        mAxisMaximum = 2*mAxisMaximum;
        mAxisRange = Math.abs(this.mAxisMaximum - this.mAxisMinimum);
        Log.e("axis", "reset min " + mAxisMinimum + " max " + mAxisMaximum + " range " + mAxisRange);
